...
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    [AddComponentMenu("XR/Locomotion/Gravitational Move Provider (Action-based)", 11)]
    
    public class GravitationalMoveProvider : GravitationalMoveProviderBase
    {
